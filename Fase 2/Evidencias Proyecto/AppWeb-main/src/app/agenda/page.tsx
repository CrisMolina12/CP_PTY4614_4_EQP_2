...
import { ChevronLeft, ChevronRight, Edit2, Trash2, X, Check, Search, Filter, Calendar as CalendarIcon, Clock } from 'lucide-react';
        ...
        {Array.from({ length: 42 }, (_, i) => {
          ...
          return (
            <motion.div
              ...
              className={`p-2 rounded-lg ${isCurrentMonth ? 'bg-white' : 'bg-gray-100'} ${isToday ? 'border-2 border-purple-500' : ''} shadow-sm transition-all duration-300 hover:shadow-md cursor-pointer`}
            >
              ...
              {dayEvents.slice(0, 3).map((event, index) => (
                <div
                  ...
                  className="mt-1 px-2 py-1 text-xs rounded-full bg-purple-100 text-purple-800 truncate"
                >
                  {event.title}
                </div>
              ))}
            ...
            >
              <div className="bg-white rounded-2xl p-6 w-full max-w-md">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <p><span className="font-medium text-purple-600">Descripción:</span> {selectedEvent.description}</p>
                  <p><span className="font-medium text-purple-600">Cliente:</span> {selectedEvent.client_id}</p>
                </div>
